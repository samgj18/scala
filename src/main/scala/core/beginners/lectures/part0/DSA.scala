...
/** In computer programming terms, an algorithm is a set of well-defined
  ...
  * # Examples:
  *
  *   - Algorithm to add two numbers: [x] Step 1: Start [x] Step 2: Declare
  *     variables num1, num2 and sum. [x] Step 3: Read values num1 and num2. [x]
  *     Step 4: Add num1 and num2 and assign the result to sum. sum←num1+num2
  *     [x] Step 5: Display sum [x] Step 6: Stop
  *
  *   - Find the largest number among three numbers: [x] Step 1: Start [x] Step
  *     2: Declare variables a,b and c. [x] Step 3: Read variables a,b and c.
  *     [x] Step 4: Step 4: If a > b If a > c Display a is the largest number.
  *     Else Display c is the largest number. Else If b > c Display b is the
  *     largest number. Else Display c is the greatest number. [x] Step 5: Stop
  *
  * Data structure is a storage that is used to store and organize data. Data
  * structure and data types are slightly different. Data structure is the
  ...
  *   - Linked List
  *
  * Elements in non-linear data structures are not in any sequence. Instead they
  * are arranged in a hierarchical manner where one element will be connected to
  ...
  *
  *   - Big-O notation: Big-O notation represents the upper bound of the running
  *     time of an algorithm. Thus, it gives the worst-case complexity of an
  *     algorithm.
  *   - Omega notation: Omega notation represents the lower bound of the running
  *     time of an algorithm. Thus, it provides the best case complexity of an
  *     algorithm.
  *   - Theta notation: Theta notation encloses the function from above and
  *     below. Since it represents the upper and the lower bound of the running
  ...
  *   - Conquer: Solve the smaller sub-problems recursively. If the subproblem
  ...
  *
  * One of the applications of Divide and Conquer is to sort an array (i.e.
  * Merge Sort)
  *
  ...
  * [7 | 6 | 1] [5 | 4 | 3]
  *
  *  2. Again, divide each subpart recursively into two halves until you get individual elements, i.e:
  * [7 | 6 | 1]
  *   |\____
  *   |     \
  *   |      \
  ...
  * these subproblems are further solved recursively. The result of each
  * subproblem is not stored for future reference, whereas, in a dynamic
  ...
  * multiple times. Use the dynamic approach when the result of a subproblem is
  * to be used multiple times in the future.
  */
